<div class="row">
    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Some Information Here</h3>
            </div>
    ...
    <div class="col-md-6">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">PES PLANNING AND BUDGETING</h3>
            </div>
                ...
                <table class="table table-stripped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a data-toggle="modal" data-target="#ResourceMobilization" class="btn btn-info">Approved Plans</a>
                            <a data-toggle="modal" data-target="#Opportunity" class="btn btn-success">Approved Budget</a>
