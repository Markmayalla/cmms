...
<head>
    <meta charset="UTF-8">
    <title>WellnessTz | Dashboard</title>
...
<input type="hidden" name="session_email" id="session_email" value="<?PHP echo $this->session->userdata('email'); ?>" />
<div id="#video_out"></div>
<?PHP $this->load->view('includes/form_generator.php'); ?>