<div class="row" style="margin-top:25px;">
	<div class="col-md-12">
		<?php
			...
			$num_user = count($alldata);
			$to_delete = $data['data'];
			$this->table->set_heading('Asset Id', 'Asset Name', 'Model Name', 'Options');
			for($i = 0; $i < $num_user; $i++){
				$data = $alldata[$i];
				//print_r($data);
                $assign_btn = '<a onclick="loadAssetId(\''.$data->id.'\')" href="#assign_assets"  data-toggle="modal" class="btn btn-sm btn-success"><span class="fa fa-reorder"></span> </a>';
